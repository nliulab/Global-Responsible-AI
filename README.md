...
| [CANAIRI](https://www.nature.com/articles/s41591-024-03364-1)            | Prediction Models    | Translational Trials       | Evaluation          | CANAIRI promotes the use of translational trials to assess the integration of AI systems into real-world clinical workflows, prioritizing fairness and system performance. |
| [CANGARU](https://arxiv.org/abs/2307.08974)                              | LLMs                 | Reporting                  | Bias and Risk Assessment                | Establishes guidelines for responsible use of LLMs like ChatGPT.                                                                                                |
| [CRAFT-MD](https://www.nature.com/articles/s41591-024-03328-5)           | LLMs                 | Testing of Clinical LLMs                   | Evaluation                        | Evaluates a clinical LLM by simulating active collection and integration of information through a doctor–patient conversation, similar to a physician’s interaction with patients. |
| [CHAI Model Card](https://github.com/coalition-for-health-ai/amc-schema) | Prediction Models    | AI Solution                                | Implementation                    | The applied model card describes an AI solution focused on the application in a health use case. This AI solution will be embedded within an AI system, which includes the fully operational AI use case, including the model(s), technical infrastructure, and personnel in the workflow. |
| [CHART](https://bmjopen.bmj.com/content/14/5/e081155)                    | LLMs                 | Chatbot Evaluation         | Whole Lifecycle                        | Provides structured reporting standards for evaluating LLM-linked chatbots.                                                                                      |
...
| [STANDING Together](https://www.thelancet.com/journals/landig/article/PIIS2589-7500%2824%2900224-3/fulltext) | Prediction Models    | Identification and Mitigation of Algorithmic Biases | Bias and Risk Assessment          | Encourages transparency regarding limitations of health datasets and proactive evaluation of their effect across population groups to mitigate biases and prevent health inequalities. |
| [STARD-AI](https://bmjopen.bmj.com/content/11/6/e047709)                 | Prediction Models    | Reporting Standards        | Model Development, Evaluation                        | Focuses on diagnostic AI studies, ensuring reproducibility and reliability.                                                                                      |
...
| [MOH AIHGle](https://isomer-user-content.by.gov.sg/3/9c0db09d-104c-48af-87c9-17e01695c67c/1-0-artificial-in-healthcare-guidelines-(aihgle)_publishedoct21.pdf) | Regional (Singapore) | Offers specific guidance for AI use in Singapore’s healthcare ecosystem, emphasizing safety, transparency, and accountability. |
